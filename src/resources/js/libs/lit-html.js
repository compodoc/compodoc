...
!(function(t, e) {
    ...
    var p = function p(t) {
        ...
        g = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F \x09\x0a\x0c\x0d"'>=\/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
    var v = (function() {
        function v(t, e, s) {
    ...
    var x = (function(_f) {
        ...
        _createClass(x, [
            ...
            },
            {
                key: 'getTemplateElement',
                value: function getTemplateElement() {
                    var t = _get(_getPrototypeOf(x.prototype), 'getTemplateElement', this).call(
                            this
                        ),
                        e = t.content,
                        s = e.firstChild;
