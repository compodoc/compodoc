            ...
            function(t, e, o) {
                ...
                e.exports = {
                    enable: function(t) {
                        ...
                        e ||
                            ((e = document.createElementNS(n.svgNS, 'defs')), t.svg.appendChild(e));
            ...
            function(t, e, o) {
                            ...
                            this.publicInstance ||
                                (this.publicInstance = this.pi = {
                                    ...
                                    disableControlIcons: function() {
                                        return (
                                            t.options.controlIconsEnabled &&
                                                ((t.options.controlIconsEnabled = !1),
                                                i.disable(t)),
                                            t.pi
                                        );
                                    },
                                    ...
                                    zoomIn: function() {
                                        return (
                                            this.zoomBy(1 + t.options.zoomScaleSensitivity), t.pi
                                        );
                                    },
                                    zoomOut: function() {
                                        return (
                ...
                var c = [],
                    p = function(t, e) {
                        ...
                        return (
                            c.push({ svg: o, instance: new l(o, e) }),
                ...
                document.documentMode && (i = 'ie'),
                    (e.exports = {
                        ...
                        getOrCreateViewport: function(t, e) {
                            ...
                            var l = [];
                            return (
                                o.getAttribute('class') && (l = o.getAttribute('class').split(' ')),
