...
const TEST_FOLDER = "angularexpo-tests",
    GIT_REPOSITORIES = [
        ...
        },
        {
            ...
            maintainer: "geromegrignon",
            tsconfig_path: "./CleanArchitecture.Presentation.Web.Client/",
            tsconfig_file: "tsconfig.json",
        },
    ],
                ...
                compodoc(GIT_REPOSITORIES[i]).then(
                    (stdout, stderr) => {
                        ...
                        if (stdout && stdout.match(reg)) {
                            printStat(stdout);
                            GIT_REPOSITORIES[i].filesLength =
                                stdout.match(reg).length;
                        }
                        console.log("");
                        i++;
                        loop();
                    ...
                    (stdout, stderr) => {
                        console.log("");
                        console.error(
                            `   Compodoc ${GIT_REPOSITORIES[i].name} KO`,
                        );
                        if (stdout && stdout.match(reg)) {
                            printStat(stdout);
                            GIT_REPOSITORIES[i].filesLength =
