...
var Dependencies = (function () {
    ...
    Dependencies.prototype.visitInput = function (property, inDecorator) {
        ...
        return {
            ...
            description: marked__default(this.breakLines(ts.displayPartsToString(property.symbol.getDocumentationComment())))
        };
    };
    ...
    Dependencies.prototype.visitCallDeclaration = function (method) {
        var _this = this;
        return {
            description: marked__default(this.breakLines(ts.displayPartsToString(method.symbol.getDocumentationComment()))),
    ...
    Dependencies.prototype.visitClassDeclaration = function (fileName, classDeclaration) {
        ...
        var description = marked__default(this.breakLines(ts.displayPartsToString(symbol.getDocumentationComment())));
