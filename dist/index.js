                        ...
                        var process = function (initialArray, _var) {
                            ...
                            if (found) {
                                ...
                                newVar.forEach(function (newEle) {
                                    if (typeof _$4.find(initialArray, { 'name': newEle.name }) === 'undefined') {
