...
describe("CLI simple generation - big app", () => {
    ...
    before((done) => {
        ...
        todoMVCComponentFile = read(
            `${distFolder}/components/TodoMVCComponent.html`,
        );
        footerComponentFile = read(
            `${distFolder}/components/FooterComponent.html`,
        );
        homeComponentFile = read(`${distFolder}/components/HomeComponent.html`);
        aboutComponentFile = read(
            `${distFolder}/components/AboutComponent.html`,
        );
        ...
        doNothingDirectiveFile = read(
            `${distFolder}/directives/DoNothingDirective.html`,
        );
    ...
    it("should have generated interfaces", () => {
        const isInterfaceExists = exists(
            distFolder + "/interfaces/ClockInterface.html",
        );
    ...
    it("should have correct links for {@link into main description and constructor}", () => {
        expect(todoClassFile).to.contain(
            'See <a href="../injectables/TodoStore',
        );
        expect(todoClassFile).to.contain(
            'Watch <a href="../injectables/TodoStore',
        );
    });
    ...
    it("should have override types for arguments of function", () => {
        expect(todoStoreFile).to.contain(
            'code><a href="../classes/Todo.html" target="_self" >To',
        );
    });
    ...
    it("should support self-defined type", () => {
        expect(todoClassFile).to.contain(
            "../miscellaneous/typealiases.html#PopupPosition",
        );
        expect(typeAliasesFile).to.contain(
    ...
    it("should support interceptors", () => {
        ...
        const fileTest = exists(
            distFolder + "/interceptors/NoopInterceptor.html",
        );
    ...
    it("should support entryComponents for modules", () => {
        ...
        expect(aboutModuleFile).to.contain(
            'href="../components/AboutComponent.html"',
        );
    });
    ...
    it("should display project local TypeScript version", () => {
        expect(stdoutString).to.contain(
            "TypeScript version of current project",
        );
    });
    ...
    it("should support multiple union types with array again", () => {
        expect(typeAliasesFile).to.contain(
            "<code>number | string | (number | string)[]</code>",
        );
    });
    ...
    it("correct support function with empty typed arguments", () => {
        expect(appComponentFile).to.contain(
            "<code>openSomeDialog(model: unknown,",
        );
    });
    ...
    it("correct supports ArrayType", () => {
        expect(interfaceIDATAFile).to.contain(
            "<code>[number, string, number[]]</code>",
        );
    });
    ...
    it("should support inheritance between component and directive", () => {
        ...
        expect(file).to.contain(
            'BaseDirective.html" target="_self" >BaseDirective',
        );
    ...
    it("should support destructuring for functions", () => {
        ...
        expect(file).to.contain(
            "<code>sumFunction(trackId: unknown, __namedParameters: {a",
        );
    ...
    it("should support destructuring for variables / object - variable names", () => {
        const file = read(distFolder + "/miscellaneous/variables.html");
        expect(file).to.contain('<a name="question"');
        expect(file).to.contain('<a name="answer"');
    });

    it("should support destructuring for variables / object - types inferred from function return type", () => {
        const file = read(distFolder + "/miscellaneous/variables.html");
        expect(file).to.contain("string");
        expect(file).to.contain("number");
    });

    it("should support destructuring for variables / object - JSDoc preserved", () => {
        const file = read(distFolder + "/miscellaneous/variables.html");
    ...
    it("should support destructuring for variables / object - default value is function call", () => {
        const file = read(distFolder + "/miscellaneous/variables.html");
        expect(file).to.contain("getQuestionAndAnswer()");
    });
    ...
    it("should support JSDoc @link in JSDoc @see tag", () => {
        ...
        expect(file).to.contain(
            'See <a href="../classes/Todo.html">Todo</a> for details',
        );
    });
    ...
    it("should support JSDoc @link for setters and getters", () => {
        const file = read(distFolder + "/injectables/TodoStore.html");
        expect(file).to.contain(
            'or link to <a href="../classes/Todo.html">Todo',
        );
        expect(file).to.contain(
            'ore link to <a href="../classes/Todo.html">Todo',
        );
    });
    ...
    it("should support JSDoc @link for inputs", () => {
        const file = read(distFolder + "/components/HeaderComponent.html");
        expect(file).to.contain(
            '_fullName <a href="https://compodoc.app/">https://compodoc.app/',
        );
    });
    ...
    it("should not crash with invalid JSDoc @link tags", () => {
        ...
        expect(file).to.contain(
            "if this {@link AboutComponent.fullName} does not crash",
        );
    ...
    it("should support multiple decorators for component for example", () => {
        const file = read(distFolder + "/components/AboutComponent.html");
        expect(file).to.contain(
            "<code>src/app/about/about.component.ts</code>",
        );
    });
    ...
    it("should support double layer spread for modules", () => {
        ...
        expect(file).to.contain(
            'href="../components/HeaderComponent.html">HeaderComponent',
        );
    });
    ...
    it("should support class name includes an interface name", () => {
        ...
        expect(file).to.contain(
            'href="../classes/AaBb.html" target="_self" >AaBb',
        );
    });
    ...
    it("should support service/injectable export in module providers", () => {
        const file = read(distFolder + "/modules/FooterModule.html");
        expect(file).to.contain(
            'href="../injectables/EmitterService.html">EmitterService',
        );
    });
    ...
    it("should support Host Directives for directives and components", () => {
        ...
        file = read(
            distFolder + "/directives/HighlightAndBorderDirective.html",
        );
        expect(file).to.contain('<td class="col-md-3">HostDirectives</td>');
        expect(file).to.contain(
    ...
    describe("input signals", () => {
        it("should support input signals", () => {
            const file = read(
                distFolder + "/components/CompodocComponent.html",
            );
