...
describe("CLI Export", () => {
    ...
    describe("when specified JSON", () => {
        ...
        it("should display descriptions and raw descriptions", () => {
            ...
            expect(file).to.contain(
                '"description": "<p>The current time</p>\\n',
            );
            ...
            expect(file).to.contain(
                '"description": "<p>the transform function</p>\\n',
            );
            ...
            expect(file).to.contain(
                '"rawdescription": "A foo bar function. Test link for other class {@link ListComponent}"',
            );
            expect(file).to.contain(
                '"description": "<p>A foo bar function. Test link for other class {@link ListComponent}</p>\\n"',
            );

            // miscellaneous enum
            expect(file).to.contain(
                '"rawdescription": "Directions of the app"',
            );
            expect(file).to.contain(
                '"description": "<p>Directions of the app</p>\\n"',
            );

            // miscellaneous typealias
            expect(file).to.contain(
                '"rawdescription": "Type alias for callback function"',
            );
            expect(file).to.contain(
                '"description": "<p>Type alias for callback function</p>\\n"',
            );

            // input with JSDoc starting with a custom tag (issue #1601)
            expect(file).to.contain(
                '"rawdescription": "\\n\\nThe number of lines to display per row. This adjusts the row height.\\n\\nThe minimum value is 2 lines.\\n"',
            );
            expect(file).to.contain(
                '"description": "<p>The number of lines to display per row. This adjusts the row height.</p>\\n<p>The minimum value is 2 lines.</p>\\n"',
            );
        });
        ...
        it("should display deprecated and deprecation messages", () => {
            ...
            // method
            expect(file).to.contain(
                '"deprecationMessage": "the transform function is deprecated"',
            );
            ...
            // accessor (setter)
            expect(file).to.contain(
                '"deprecationMessage": "This setter is deprecated"',
            );

            // accessor (getter)
            expect(file).to.contain(
                '"deprecationMessage": "This getter is deprecated"',
            );
        });
        ...
        it("should contain numerical enumerations with strict numerical values", () => {
            ...
            const valHigh = pollingSpeedEnum.childs.find(
                (child) => child.name === "High",
            );
        ...
        it("should export custom input decorators for components", () => {
            ...
            const input = component.inputsClass.find(
                (inp) => inp.name === "myInput",
            );

            expect(
                input.decorators.find(
                    (dec) => dec.name === "MyCustomInputDecorator",
                ),
            ).to.be.ok;
        });
        ...
        it("should get jsdoctags in component", () => {
            ...
            // HostListener
            expect(file).to.contain(
                '"comment": "<p>component hostListener</p>',
            );
            ...
            // Method
            expect(file).to.contain(
                '"comment": "<p>component method param</p>',
            );
            expect(file).to.contain(
                '"comment": "<p>component method return</p>',
            );
        });
        ...
        it("should get jsdoctags in directive", () => {
            ...
            // HostListener
            expect(file).to.contain(
                '"comment": "<p>directive hostListener</p>',
            );
            ...
            // Method
            expect(file).to.contain(
                '"comment": "<p>directive method param</p>',
            );
            expect(file).to.contain(
                '"comment": "<p>directive method return</p>',
            );
        });
        ...
        it("should get modules informations", () => {
            ...
            // Description
            expect(file).to.contain(
                '"description": "<p>The list of todos module',
            );
