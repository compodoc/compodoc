    ...
    describe('full path in JSON', () => {
        ...
        before(function (done) {
            ...
            let ls = shell('node', [
                ...
                '--unitTestCoverage', './test/fixtures/todomvc-ng2/coverage-summary.json',
                '-d', distFolder]);
      ...
      it('should have full file path links', ()=>{
        expect(unitTestFile).to.contain('<a href="./components/AppComponent.html">test/fixtures/todomvc-ng2/src/app/app.component.ts</a>');
        expect(unitTestFile).to.contain('<a href="./components/AboutComponent.html">test/fixtures/todomvc-ng2/src/app/about/about.component.ts</a>');
      });
    });
    ...
    describe('partial path in JSON', () => {
        ...
        before(function (done) {
            ...
            let ls = shell('node', [
                './bin/index-cli.js',
                '-p', './test/fixtures/todomvc-ng2/src/tsconfig.json',
                '--unitTestCoverage', './test/fixtures/todomvc-ng2/coverage-summary-alt.json',
                '-d', distFolder]);
      ...
      it('should have partial file path links', ()=>{
        expect(unitTestFile).to.contain('<a href="./components/AppComponent.html">src/app/app.component.ts</a>');
        expect(unitTestFile).to.contain('<a href="./components/AboutComponent.html">src/app/about/about.component.ts</a>');
      });
    });
