...
describe('CLI Unit Test Report', () => {
    ...
    describe('full path in JSON', () => {
      ...
      it('should have full file path links', ()=>{
        expect(unitTestFile).to.contain('<a href="./components/AppComponent.html">test/src/todomvc-ng2/src/app/app.component.ts</a>');
        expect(unitTestFile).to.contain('<a href="./components/AboutComponent.html">test/src/todomvc-ng2/src/app/about/about.component.ts</a>');
      });
    });
    ...
    describe('partial path in JSON', () => {
        ...
        before(function (done) {
            ...
            let ls = shell('node', [
                './bin/index-cli.js',
                '-p', './test/src/todomvc-ng2/src/tsconfig.json',
                '--unitTestCoverage', './test/src/todomvc-ng2/coverage-summary-alt.json',
                '-d', distFolder]);
